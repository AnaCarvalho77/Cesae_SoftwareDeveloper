...
<head>
  ...
  <title>localhost / localhost / escola | phpMyAdmin 5.2.1</title>
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=escola&table=aluno">
    `escola`.`aluno`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=escola&table=aluno_disciplina">
    `escola`.`aluno_disciplina`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=escola&table=disicplina">
    `escola`.`disicplina`
  </a>
</li>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZXNjb2xh" data-vpath="cm9vdA==.ZXNjb2xh" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=escola"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=escola" title="Structure">escola</a>
  ...
  <li class="last database">
    ...
    <div class="clearfloat"></div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;escola&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="5c57496062583e5f33347034265d7a27">
  ...
  <ol class="breadcrumb breadcrumb-navbar">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="localhost" draggable="false">
        ...
        <a href="index.php?route=/database/structure&db=escola" data-raw-text="escola" draggable="false">
          Database:          escola
        </a>
      </li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&db=escola">
              <img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure
                              <span class="visually-hidden">(current)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&db=escola">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&db=escola">
              <img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_search">&nbsp;Search
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&db=escola">
              <img src="themes/dot.gif" title="Query" alt="Query" class="icon ic_s_db">&nbsp;Query
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&db=escola">
              <img src="themes/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&db=escola">
              <img src="themes/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&db=escola">
              <img src="themes/dot.gif" title="Operations" alt="Operations" class="icon ic_b_tblops">&nbsp;Operations
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&db=escola&checkprivsdb=escola&viewing_mode=db">
              <img src="themes/dot.gif" title="Privileges" alt="Privileges" class="icon ic_s_rights">&nbsp;Privileges
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&db=escola">
              <img src="themes/dot.gif" title="Routines" alt="Routines" class="icon ic_b_routines">&nbsp;Routines
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&db=escola">
              <img src="themes/dot.gif" title="Events" alt="Events" class="icon ic_b_events">&nbsp;Events
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&db=escola">
              <img src="themes/dot.gif" title="Triggers" alt="Triggers" class="icon ic_b_triggers">&nbsp;Triggers
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/tracking&db=escola">
              <img src="themes/dot.gif" title="Tracking" alt="Tracking" class="icon ic_eye">&nbsp;Tracking
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&db=escola">
              <img src="themes/dot.gif" title="Designer" alt="Designer" class="icon ic_b_relations">&nbsp;Designer
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/central-columns&db=escola">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE aluno_disciplina
ADD FOREIGN KEY (id_aluno) REFERENCES aluno(id_aluno),
ADD FOREIGN KEY (id_disciplina) REFERENCES disicplina(id_disciplina);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="escola" targettable="aluno_disciplina">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `aluno_disciplina`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="escola" targettable="disicplina">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `disicplina`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="escola" targettable="aluno_disciplina">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE aluno_disciplina
ADD FOREIGN KEY (id_aluno) REFERENCES aluno (id_aluno),
ADD FOREIGN KEY (id_disciplina) REFERENCES disciplina (id_disciplina);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="escola" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO aluno (dataInscricao, idade, localidade, morada, nome)
VALUES 
(&#039;2020-06-12&#039;,&#039;18&#039;,&#039;maia&#039;,&#039;Rua das Flores&#039;, &#039;Maria Ferreira&#039;),
(&#039;2021-09-02&#039;,&#039;20&#039;,&#039;porto&#039;, &#039;Avenida Especial&#039;, &#039;Ana Lopes&#039;),
(&#039;2020-09-03&#039;,&#039;20&#039;,&#039;lisboa&#039;, &#039;Rua Coisa&#039;, &#039;Antonieta Dias&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="escola" targettable="">
                            <div class="action_content">
...
(&#039;2020-09-03&#039;,&#039;20&#039;,&#039;lisboa&#039;, &#039;Rua Coisa&#039;, &#039;Antonieta Dias&#039;);</span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO curso (dataCriacao, descricao)
VALUES 
(&#039;2001-06-12&#039;,&#039;Fiscalidade&#039;),
(&#039;2001-09-02&#039;,&#039;Engenharia Infomática&#039;),
(&#039;2001-09-03&#039;,&#039;Matemática&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="escola" targettable="">
                            <div class="action_content">
...
(&#039;2001-09-03&#039;,&#039;Matemática&#039;);</span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO disciplina (descricao)
VALUES 
...
(&#039;Impostos sobre os rendimentos singulares&#039;),
...
(&#039;Estatística Aplicada&#039;);</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="escola" targettable="aluno">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT nome, morada
FROM aluno;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="escola" targettable="aluno">
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;escola&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="5c57496062583e5f33347034265d7a27">
...
<input type="hidden" name="db" value="escola"><input type="hidden" name="token" value="5c57496062583e5f33347034265d7a27">
<div class="table-responsive">
<table class="table table-striped table-hover table-sm w-auto data">
    <thead>
        <tr>
            <th class="d-print-none"></th>
            <th><a href="index.php?route=/database/structure&db=escola&pos=0&sort=table&sort_order=DESC" title="Sort" onmouseover="$(&#039;.sort_arrow&#039;).toggle();" onmouseout="$(&#039;.sort_arrow&#039;).toggle();">Table <img src="themes/dot.gif" title="" alt="Ascending" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Descending" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="d-print-none">
                Action            </th>
                        <th>
                <a href="index.php?route=/database/structure&db=escola&pos=0&sort=records&sort_order=DESC" title="Sort">Rows</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="./doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="index.php?route=/database/structure&db=escola&pos=0&sort=type&sort_order=ASC" title="Sort">Type</a></th>
                <th><a href="index.php?route=/database/structure&db=escola&pos=0&sort=collation&sort_order=ASC" title="Sort">Collation</a></th>
            
                                            <th><a href="index.php?route=/database/structure&db=escola&pos=0&sort=size&sort_order=DESC" title="Sort">Size</a></th>
                                <th><a href="index.php?route=/database/structure&db=escola&pos=0&sort=overhead&sort_order=DESC" title="Sort">Overhead</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="ALUNO">
    ...
    <th>
        <a href="index.php?route=/sql&db=escola&table=aluno&pos=0" title="">aluno</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="ca0cd09a12abade3bf0777574d9f987f_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=escola&ajax_request=1&favorite_table=aluno&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="1b54f56231e8e6573936e5ee155f1373">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=escola&table=aluno&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=escola&table=aluno">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=escola&table=aluno">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
            ...
            <a href="index.php?route=/table/change&db=escola&table=aluno"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=escola&table=aluno&sql_query=TRUNCATE+%60aluno%60&message_to_show=Table%2Baluno%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=escola&table=aluno&reload=1&purge=1&sql_query=DROP+TABLE+%60aluno%60&message_to_show=Table+aluno+has+been+dropped.">
            ...
            data-table="aluno">
                ...
                <a href="index.php?route=/table/structure&db=escola&table=aluno#showusage">
            ...
            <tr id="row_tbl_2" data-filter-row="ALUNO_DISCIPLINA">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="aluno_disciplina"
            id="checkbox_tbl_2">
    </td>
    <th>
        <a href="index.php?route=/sql&db=escola&table=aluno_disciplina&pos=0" title="">aluno_disciplina</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="7a270915edea8720802b510814fc8c97_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=escola&ajax_request=1&favorite_table=aluno_disciplina&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="4e462db6a41ccf6e51e75d7a850003c7">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=escola&table=aluno_disciplina&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=escola&table=aluno_disciplina">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=escola&table=aluno_disciplina">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=escola&table=aluno_disciplina"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=escola&table=aluno_disciplina&sql_query=TRUNCATE+%60aluno_disciplina%60&message_to_show=Table%2Baluno_disciplina%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=escola&table=aluno_disciplina&reload=1&purge=1&sql_query=DROP+TABLE+%60aluno_disciplina%60&message_to_show=Table+aluno_disciplina+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="aluno_disciplina">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=escola&table=aluno_disciplina#showusage">
                    <span>32.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_3" data-filter-row="CURSO">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=escola&table=curso&pos=0" title="">curso</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="1042013feadea5404c396dc5b7eb62ed_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=escola&ajax_request=1&favorite_table=curso&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="796b3affd5a0a97f3409e64e00ecdd01">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=escola&table=curso&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=escola&table=curso">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=escola&table=curso">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=escola&table=curso"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=escola&table=curso&sql_query=TRUNCATE+%60curso%60&message_to_show=Table%2Bcurso%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=escola&table=curso&reload=1&purge=1&sql_query=DROP+TABLE+%60curso%60&message_to_show=Table+curso+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="curso">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=escola&table=curso#showusage">
            ...
            <tr id="row_tbl_4" data-filter-row="DISCIPLINA">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=escola&table=disciplina&pos=0" title="">disciplina</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="e382fa9c1631cba5cf37dd37a260d0d7_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=escola&ajax_request=1&favorite_table=disciplina&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="2526dfe3a29cb49142e922dca54b5eca">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=escola&table=disciplina&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=escola&table=disciplina">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=escola&table=disciplina">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=escola&table=disciplina"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=escola&table=disciplina&sql_query=TRUNCATE+%60disciplina%60&message_to_show=Table%2Bdisciplina%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=escola&table=disciplina&reload=1&purge=1&sql_query=DROP+TABLE+%60disciplina%60&message_to_show=Table+disciplina+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="disciplina">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=escola&table=disciplina#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
...
<tr>
    ...
    <th class="tbl_num text-nowrap">
                ...
                <th colspan="7" class="d-print-none">Sum</th>
                                                <th class="value tbl_rows font-monospace text-end">23</th>
  ...
  <p class="d-print-none">
    ...
    <a href="index.php?route=/database/data-dictionary&db=escola&goto=index.php%3Froute%3D%2Fdatabase%2Fstructure">
  ...
  <div class="card-body row row-cols-lg-auto g-3">
    ...
    <div class="col-12 align-self-lg-end">
      ...
      <a href="index.php?route=%2Fdatabase%2Fstructure&amp;db=escola&amp;server=1" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer">
