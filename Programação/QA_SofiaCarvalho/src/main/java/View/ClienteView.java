...
public class ClienteView {
    ...
    public static void menuCliente() throws FileNotFoundException {
        ...
        ClientController clientController = new ClientController("/Users/anasofiacarvalho/Documents/GitHub/Cesae_SoftwareDeveloper/Programação/QA_SofiaCarvalho/src/main/resources/minimercado.csv");
        int opcao = 0;
