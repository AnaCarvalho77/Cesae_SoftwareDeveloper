...
//        }
        ...
        double tenpoRecord = pistaCorrida.getTempoRecordeSeg();
        ...
        if(tempoTotal < tenpoRecord){
            pilotoAtual.setFichasCorrida(pilotoAtual.getFichasCorrida()+premiorecord);
            pilotoAtual.setVitorias(pilotoAtual.getVitorias() + 1);
            System.out.println("Superou o Record da pista! Completou a corrida em : " + tempoTotal + " e o tempo recorde era de " + tenpoRecord);
        }else{
            pilotoAtual.setFichasCorrida(pilotoAtual.getFichasCorrida()+(premiorecord/2));
            System.out.println("Não bateu o Record da pista! Completou a corrida em : " + tempoTotal + " e o tempo recorde era de " + tenpoRecord);
        }
        return tempoTotal;
